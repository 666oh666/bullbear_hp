        ...
        <?php else: ?>
            ...
            <div class="bx-slider">
				<div class="slides">
					...
					<div class="slider-caption">
						<div class="mid-content">
							<p class="caption-title">Welcome to BullBear</p>
				...
				<div class="slides">
					...
					<div class="slider-caption">
						<div class="ak-container">
							<p class="caption-title" style="text-shadow: 2px 2px 9px rgba(0,0,0,0.4);">Welcome to BullBear</p>
							<h2 class="caption-description" style="text-shadow: 2px 2px 9px rgba(0,0,0,0.4);">
							<p>エネルギーをあるべき方向へ</p>
							</h2>
							</div>
					</div>
...
<!--
				<div class="slides">
					<img src="<?php echo get_template_directory_uri(); ?>/images/demo/slider3a.bmp" alt="slider3" height="500px;">
					<div class="slider-caption">
						<div class="mid-content">
							<p class="caption-title">Welcome to BullBear</p>
							<h2 class="caption-description">
