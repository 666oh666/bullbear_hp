...
<div id="submenu" class="submenu4C" style="margin-top:80px; margin-bottom:25px;">
<ul style="padding-left:1482px;">
	<li><a title="ブルベアについて" href="#about_us">ブログ</a></li>
</ul>
</div>
...
<div class="blog_con">
	<h2 class="heading heading_primary" style="">新着記事</h2>
